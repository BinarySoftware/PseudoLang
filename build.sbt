...
scalacOptions in ThisBuild ++= Seq(
  ...
  "-Xmacro-settings:-logging@org.enso",       // Disable the debug logging globally for Enso libraries.
  "-Xmacro-settings:-logging@org.PseudoLang", // Disable the debug logging globally for PseudoLang libraries.
